...
namespace MimeLib
{
    public static class MimeTypes
    {
        ...
        public static Category ParseCategory(string mime)
        {
            if (Text.Contains(mime))
            {
                return Category.Text;
            }
            if (Audio.Contains(mime))
            {
            ...
            if (CSS.Contains(mime))
            {
                return Category.CSS;
            }
            if (Script.Contains(mime))
            {
                return Category.Script;
            }
            if (Image.Contains(mime))
            {
                return Category.Image;
            }
            if (Flash.Contains(mime))
            {
            ...
            if (XML.Contains(mime))
            {
                return Category.XML;
            }
            if (Font.Contains(mime))
            {
        ...
        public static string ConvertExtensionToMimeType(string extension)
        {
            ...
            return MimeMapping.GetMimeMapping($"generic{extension}");
        }
        ...
        /// <summary>WebP lossless and lossy compression for images on the web </summary>
        ...
        #region Json Category List

        public static List<string> Json = new List<string>
        {
            ApplicationJson,
        };
        ...
        #region XML Category List

        public static List<string> XML = new List<string>
        {
            ApplicationAtomXml,
            ApplicationXml,
            TextXml
        ...
        #region HTML Category List

        public static List<string> HTML = new List<string>
        {
            TextHtml,
        };
        ...
        #region Flash Category List

        public static List<string> Flash = new List<string>
        {
